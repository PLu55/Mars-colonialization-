...
namespace PLu.Mars.Kernel
{
    public class Sun : MonoBehaviour
    {
        ...
        void Update()
        {
            _timer.Tick(GameController.Instance.deltaTime);
        ...
        void UpdateSun()
        {
            ...
            double globalTime = GameController.Instance.GlobalTime;
            ...
            float declination = CelestialCalculator.SolarDeclinationAngle( GameController.Instance.GlobalTime);
